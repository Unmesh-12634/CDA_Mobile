...
class VoiceService:
    ...
    def record_microphone_audio(self, duration_seconds: int = 15, sample_rate: int = 16000) -> Optional[Path]:
    ...
    def record_and_transcribe(self, duration_seconds: int = 20) -> str:
