          ...
          children: [
            ...
            Row(
              ...
              children: [
                ...
                // Badge — Apple Match Pill Gradient
                Container(
            ...
            Row(
              children: [
                Icon(Icons.payments_outlined,
                    size: 16, color: isDark ? const Color(0xFF34D399) : const Color(0xFF10B981)),
                ...
                Icon(Icons.access_time_rounded,
                    size: 14, color: isDark ? const Color(0xFF64748B) : AppColors.outline),
                const SizedBox(width: 4),
                Text(
                  job.postedAgo,
                  style: TextStyle(
